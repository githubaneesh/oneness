                 ...
                 <div className="login-page">
                            <div className="form">
                                <form className="login-form">
                                        <InputText type="text" name="" onChange={(e) => this.inputTextChangeHandler("username", e)} />
                                        <InputText type="password" name="" onChange={(e) => this.inputTextChangeHandler("password", e)} />
